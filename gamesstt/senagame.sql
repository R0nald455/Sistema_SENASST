DROP DATABASE senagame;
CREATE DATABASE senagame;

USE senagame;

CREATE TABLE aprendiz(
cod_estudiante INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
UsuName VARCHAR(100) NOT NULL UNIQUE,
UsuContraseña VARCHAR(100)
);

CREATE TABLE instructor (
InsCode INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
InsName VARCHAR(100) NOT NULL UNIQUE,
InsContraseña VARCHAR(100)
);
