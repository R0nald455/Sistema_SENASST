...
l=aleatoriosNoRepetidos(38); //Pasamos el parámetro de los números que necesitamos.
var eliminar = 0;
...
function Comprobar(){
    ...
    if(comprobar == 1){
        ...
        console.log(fichas.sort());
        if(fichas[0] == "c0" && fichas [1] == "c1" && fichas[2] == "c10" && fichas[3] == "c11" && fichas[4] == "c12" && fichas[5] == "c13" && fichas[6] == "c14" && fichas[7] == "c15" && fichas[8] == "c16" && fichas[9] == "c17" && fichas[10] == "c18" && fichas[11] == "c19" && fichas[12] == "c2" && fichas[13] == "c20" && fichas[14] == "c21" && fichas[15] == "c22" && fichas[16] == "c23" && fichas[17] == "c24" && fichas[18] == "c25" && fichas[19] == "c26" && fichas[20] == "c27" && fichas[21] == "c3" && fichas[22] == "c4" && fichas[23] == "c5" && fichas[24] == "c6" && fichas[25] == "c7" && fichas[26] == "c8" && fichas[27] == "c9")
        {
            Swal.fire({
                title: `<h2 style="color: white;">Los elementos que has colocado son correctos. ¡Felicidades!</h2>`,
                html: '<h2 style="color: white;"> Ya conoces los elementos que tiene el botiquín tipo C. Esto te permitirá saber cuál debes usar en ocasiones de emergencia, pues saber que hay dentro te ahorrará tiempo para resolver la emergencia en el menor tiempo posible.</h2>',
                background: 'black',
                icon: 'success',
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Aceptar',
            ...
            Swal.fire({
                title: `<h2 style="color: white;">Los elemntos no son correctos para el botiquín tipo C.</h2>`,
