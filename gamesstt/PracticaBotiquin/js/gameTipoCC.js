...
const characters = [
  'tipoC/acetaminofen500',
  'tipoC/alcohol',
  'tipoC/asa100',
  'tipoC/bajalenguas',
  'tipoC/collarcervical',
  'tipoC/collarcervicalniño',
  'tipoC/compresa',
  'tipoC/esparadrapo',
  'tipoC/fonendoscopio',
  'tipoC/gasaesteril',
...
const defFonendoscopio = "Un fonendoscopio es un dispositivo médico que consta de un tubo largo y flexible, generalmente de goma o plástico, con dos auriculares en un extremo y un diafragma o una campana en el otro extremo. Los auriculares se colocan en los oídos del profesional de la salud, mientras que el diafragma o la campana se coloca sobre el cuerpo del paciente para escuchar los sonidos internos.<br>Un fonendoscopio tiene varios usos fundamentales en el campo de la medicina:<br><br>Auscultación cardiaca: Permite escuchar los sonidos cardíacos, como los latidos del corazón y los posibles soplos cardíacos, lo que es esencial para evaluar la salud cardiovascular de un paciente y detectar posibles problemas cardíacos.<br><br>Auscultación pulmonar: Se utiliza para escuchar los sonidos respiratorios, como los ruidos respiratorios normales, los ruidos anormales (como sibilancias o crepitaciones) y otros sonidos que pueden indicar afecciones pulmonares o respiratorias.<br><br>Evaluación abdominal: En algunas situaciones, se utiliza para escuchar los sonidos intestinales y otros sonidos abdominales que pueden proporcionar información sobre el funcionamiento del sistema gastrointestinal.<br><br>Evaluación de la presión arterial: En combinación con un tensiómetro (esfigmomanómetro), se utiliza para medir la presión arterial auscultatoria, que es una forma común de medir la presión arterial.";
...
const defJabon = "Un jabón líquido en un botiquín es un producto de higiene personal en forma de líquido que se utiliza para lavar y desinfectar las manos. Estos jabones están diseñados para ser utilizados por profesionales de la salud, como médicos, enfermeras y personal de atención médica, así como en entornos médicos y clínicos en general. Suelen venir en envases que permiten una dosificación precisa y controlada.Un jabón líquido en un botiquín sirve para varios propósitos importantes:<br><br>Higiene de manos: La principal función del jabón líquido es la limpieza y desinfección de las manos. Los profesionales de la salud deben mantener las manos limpias en todo momento para reducir la transmisión de gérmenes y prevenir infecciones cruzadas.<br><br>Prevención de infecciones: La correcta higiene de manos es esencial para prevenir la propagación de infecciones en entornos médicos. El uso de jabón líquido ayuda a eliminar gérmenes y patógenos que podrían estar presentes en las manos.<br><br>Preparación para procedimientos médicos: Antes de realizar procedimientos médicos, como cirugías o exámenes clínicos, los profesionales de la salud deben lavar y desinfectar sus manos de manera rigurosa para minimizar el riesgo de infecciones.";
...
const retroali = [defAcetaminofen500,defAlcohol,defAsa100,defBajalenguas,defCollarCervical,defCollarCervicalNiño,defCompresas,defEsparadrapo,defFonendoscopio,defGasaEsteril,defGasasLimpias,defGuantesLatex,defhidroxidoAluminio,defInmovilizadores,defJabon,defLinterna,defMascararcp,defPilas,defSolucion,defTablaEspinal,defTensiometro,defTermometro,defTijeras,defBan2x5,defBan3x5,defBan5x5,defVaso,defVendalgodon5x5];
  ...
  if (firstCharacter === secondCharacter) {
    ...
    if (firstCharacter === characters[indicador]){
        Swal.fire({
          ...
          html: `<div style="position: absolute; width: 150px; height: 300px;"></div><div style=" font-family: Comic Sans MS; text-align: left; color:white; font-size:20px; padding:1px;><h4 style="font-family: arial;">${retroali[indicador]}</h4></div>`,
          icon: 'info',
