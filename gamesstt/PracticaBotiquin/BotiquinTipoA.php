        ...
        <div class="principal-container">
            ...
            <div class="cont-dere">
                ...
                <div class="cont-elementos">
                    <div class="Elemento1" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="0"></div>
                    <div class="Elemento2" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="1"></div>
                    <div class="Elemento3" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="2"></div>
                    <div class="Elemento4" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="3"></div>
                    <div class="Elemento5" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="4"></div>
                    <div class="Elemento6" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="5"></div>
                    <div class="Elemento7" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="6"></div>
                    <div class="Elemento8" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="7"></div>
                    <div class="Elemento9" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="8"></div>
                    <div class="Elemento10" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="9"></div>
                    <div class="Elemento11" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="10"></div>
                    <div class="Elemento12" ondrop="dragDrop(event)" ondragover="allowDrop(event)" id="11"></div>
                </div>
            ...
            <div class="cont-izqui">
                ...
                <h1>Elementos del botiquín tipo A</h1>
