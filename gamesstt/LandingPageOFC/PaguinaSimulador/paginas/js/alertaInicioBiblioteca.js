...
function cargarPagina(){
    ...
    setTimeout(() => {
        (async () => { //async para que se ejecute primero esta alerta y hasta que se ejecute esta se ejecuta la otra.
            await Swal.fire({
                title: `<h2 style="color: #687B14;">¡Bienvenid@! al escenario de biblioteca.</h2>`,
                icon: 'question',   
                background: 'rgba(52, 56, 56, 0.677)',             
                html: '<div style="font-family: Comic Sans MS; text-align: center;"> <h2 style="color: #efefef;"> El reto consiste en que busques los posibles riesgos que puedan haber en la biblioteca... </h2> <h2 style="color: #efefef; margin-top: 50px;"> Ahora que ya conoces un poco más ¡Vamos..! </h2> </div> ',
