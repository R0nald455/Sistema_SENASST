...
var preguntas = ["Cuando al caminar un hueco logras visualizar, ten cuidado y asegurate de no pisar.","Al ver una grieta en la pared, no te acerques porque en peligro te puedes poner.","Al no estár en su lugar, un accidente puede causar.","Si a tu compañero quieres molestar, mejor piensa antes lo que puede pasar.","En el auditorio no puedes correr, pues una caída y lesiones te pueden suceder.", "Cuando en el auditorio vayas a presentar, acuerdate de siempre arriba mirar."];
