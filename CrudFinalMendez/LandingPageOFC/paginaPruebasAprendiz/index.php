                    ...
                    ?>
                        <script>
                            Swal.fire({
                                ...
                                html: '<h2 style="color: white;">Felicidades, has terminado correctamente la prueba</h2><br><h2 style="color: white;">Para conocer tus resultados puedes precionar el botón</h2>',
                                background: '#00000053',
                                icon: 'warning',
        ...
        if(!isset($_POST['grupo-inputR'])){
            ...
            if($result && $inputRadioValue === "A"){
                ...
                if($keyA>0){
                    ...
                    echo "No es la pregunta correcta";
                }
