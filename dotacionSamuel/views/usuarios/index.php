...
<head>
    ...
    <link rel="stylesheet" href="../../css/principal.css"> <!-- Ajusta la ruta a la hoja de estilos -->
</head>
...
<center><h1>Dotación</h1></center>
<a href="producto_agregar.php"><input  class="btn btn-primary" type="button" value="Agregar Dotación"></a>
</div>
<div class="col-sm-18">
