...
if (isset($_POST['update'])) {
	...
	$fechaEntra = mysqli_real_escape_string($conexion, (strip_tags($_POST['fechaEntra'], ENT_QUOTES)));


	$update = mysqli_query($conexion, "UPDATE entradasbotiquin SET id_elementos='$id_elementos', cantidad='$cantidad', comentario='$comentario', fechaEntra='$fechaEntra' WHERE id_entradas='$id_entradas'");
