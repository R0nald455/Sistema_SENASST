...
<body>
    ...
    <center>
        <a href="index.php"><img style="width: 150px; margin: 30px;" class="imagen_filtrar" src="../../../../img/LogoSena.png" alt=""></a>
        ...
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <form action="reportes.php" method="POST">
                    ...
                    <center style="margin: 20px;"><button type="submit" name="button-pdf" id="button-pdf" class="btn btn-sm btn-primary"
                        href="reportes.php"><i class="fa-solid fa-file-pdf"></i> Generar
                        PDF</button></center>
                </form>
            </li>
        </ul>
