				...
				<div class="span12">
					<div class="content">
						...
						<form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php"
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Identificador de la entrada: <input
											type="text" name="ID_Entradas" id="ID_Entradas"
											value="<?php echo $row['ID_Entradas']; ?>" placeholder=""
											class="form-control span8 tip" readonly="readonly"></label>
								</div>
							</div>
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Fecha de entrada: <input name="notelp"
