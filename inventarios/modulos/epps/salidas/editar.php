					...
					<div class="content">
						...
						<form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php"
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Identificador de la salida: <input
											type="text" name="ID_Salidas" id="ID_Salidas"
											value="<?php echo $row['ID_Salidas']; ?>" placeholder="" class="form-control"
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Identificador del EPP: <input type="text"
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Cantidad: <input name="cantidad"
											...
											class="form-control span8 tip" type="text" readonly="readonly" /></label>
								</div>
							</div>
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Fecha de salida: <input name="notelp"
											id="notelp" value="<?php echo $row['fecha']; ?>" class=" form-control span8 tip"
