									...
									<div class="modal-body">
										...
										<form enctype="multipart/form-data" name="form1" id="form1"
											...
											<div class="control-group">
												<label class="control-label" for="ID_Implementos">Elementos de proteccion
													personal:</label>
												<input class="form-control" type="text" id="ID_Implementos"
													placeholder="Buscar EPP" autocomplete="off">
											...
											<div class="control-group">
												<div class="controls">
													<label class="control-label" for="cantidad">Cantidad: <input type="text"
															name="cantidad" id="cantidad"
															placeholder="Ingrese la cantidad de implementos"
											...
											<div class="control-group">
												<div class="controls">
													<label class="control-label" for="descripcion">Descripcion: <input
															name="descripcion" id="descripcion"
															class="form-control span8 tip" type="text"
															placeholder="Descripcion del estado de los implementos"
															required /></label>
												</div>
											</div>
