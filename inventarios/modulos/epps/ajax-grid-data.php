...
$sql = "SELECT ID_Implementos, ImagenReferencia, Nombre, Descripcion, Categoria, Cantidad, Ubicacion, Fecha";
...
if (!empty($requestData['search']['value'])) {
	...
	$sql = "SELECT ID_Implementos, ImagenReferencia, Nombre, Descripcion, Categoria, Cantidad, Ubicacion, Fecha FROM tblimplementos";
...
while ($row = mysqli_fetch_array($query)) { // preparing an array
	...
	$nestedData[] = '<td><center>
                    ...
                    <a href="index.php?action=delete&ID_Implementos=' . $row['ID_Implementos'] . '" onclick="return confirmacion()"  data-toggle="tooltip" title="Eliminar" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can" style="color: #f2eded;"></i> </a>
                    </center></td>';
