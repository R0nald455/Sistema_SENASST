...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<img src="data:imag/;base64,'.base64_encode($row['ImagenReferencia']).'" alt="Imagen" style="width: 150px; height:150px;" >';
    ...
    $nestedData[] = '<td><center>
                    ...
                    <a href="index.php?action=delete&ExtintorID='.$row['ExtintorID'].'" onclick="return confirmacion()" data-toggle="tooltip" title="Eliminar" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can" style="color: #f2eded;"></i> </a>
                    </center></td>';		
