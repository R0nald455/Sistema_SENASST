					...
					<div class="content">
						...
						<form name="form1" id="form1" class="form-horizontal row-fluid" action="update-edit.php"
							...
							<div class="control-group">
								<div class="controls">
									<label class="control-label" for="basicinput">Identificador del extintor: <input
											type="text" name="ExtintorID" id="ExtintorID"
											value="<?php echo $row['ExtintorID']; ?>" placeholder="" class="form-control"
								...
								<div class="controls">
									<label class="control-label" for="TipoDeExtintor">Tipo de extintor:
										<select name="TipoDeExtintor" class="form-control"
											...
											<option value="Dioxido de carbono (CO2)">Extintor de dioxido de carbono (CO2)
											</option>
											<option value="Polvo químico especializado (por ejemplo, para metales)">Extintor
												de polvo químico especializado</option>
