    ...
    <?php if (isset($_SESSION["id"])): ?>
            ...
            <div class="menu">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="#">Camillas con revisiones pendientes</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="videos-relacionados__container">
            ...
            <iframe class="videos-relacionados__item2 width=" 560" height="315"
                ...
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen></iframe>
            <iframe class="videos-relacionados__item3" width="560" height="315" src="https://www.youtube.com/embed/QurCZgeAdig?si=p7YcdiHomFUKWyBk"
