...
<body>
    <center>
    <h1 class="animate__animated animate__backInLeft">Historial de revisiones</h1>
...
<tbody>
    ...
    <tr>
        ...
        <td style="text-align: center;"><img width="100%" src="data:image/jpg;base64,<?php echo base64_encode($row['Foto']); ?>"></td>
        <td><?php echo $row['Lugar'];  ?></td>
        <td><?php echo $row['contexto'];  ?></td>
