...
-- Tiempo de generación: 07-09-2023 a las 15:19:02
...
CREATE TABLE `botiquin` (
  ...
  `ubiEspecifica` varchar(200) NOT NULL,
  `estado` varchar(200) NOT NULL,
  `fechaRegis` date NOT NULL,
  `comentarios` text NOT NULL,
  `fechaInspec` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `botiquin` (`id_elementos`, `nombre`, `descripcion`, `cantidad`, `ubicacion`, `ubiEspecifica`, `estado`, `fechaRegis`, `comentarios`, `fechaInspec`) VALUES
(2, 'Isodine', 'Elemento utilizado para la desinfeccion de heridas abiertas', '3', 'Ganaderia', 'Entrada principal', 'Optimo', '2022-09-15', 'Elemento practico', '2024-04-15'),
(4, 'Curas', 'Elemento utilizado para tapar las heridas abiertas', '15', 'Sistemas', 'Segundo Piso', 'Optimo', '2022-03-22', 'Elemento practico', '2023-04-20'),
(7, 'Agua Oxigenada', 'Elemento utilizado para tapar desinfectar heridas', '1', 'Sistemas', 'Primer Piso', 'Optimo', '2022-05-22', 'Elemento practico', '2023-09-15');
...
--
ALTER TABLE `botiquin`
  MODIFY `id_elementos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
