...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conexion, "INSERT INTO `products`(name, contact, image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conexion, "SELECT * FROM `products` WHERE id = $edit_id");
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="email" min="0" class="box" required name="update_p_price" value="<?php echo $fetch_edit['price']; ?>">
