					...
					<ul>
						...
						<li><a href="#">Inspecciones</a>
							<ul> <b>
									...
									<li><a onclick="window.location.href='../../elementos/Model/inspecciones/index.php'">Inventario
					...
					<div class="wow fadeInUp col-md-4 col-sm-12" data-wow-delay="1s">
						<div class="overview-detail">
							...
							<p class="parrafo-landing">Hola!, <b>
									<?= $_SESSION["documento"] ?>
								</b> te contamos que nuestro sistema de seguridad SENASST te permite consultar
