                    ...
                    <div id="login-column" >
                        <div id="login-box" >
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" id="nombre" name="nombre" class="form_control" value="<?php echo $usuario['nombre'];?>"required>
                            </div>
                            <div class="form-group">
                                <label for="username">Correo:</label>
                                <br>
                                <input type="email" name="correo" id="correo" class="form_control" placeholder="" value="<?php echo $usuario['correo'];?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="number" id="rol" name="rol" class="form-control" placeholder="Escribe el rol 1 para Admin, 2 para Lector" value="<?php echo $usuario['rol'];?>" required>
